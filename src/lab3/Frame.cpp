...
void recallToFunc(const QPoint& pos, Frame* frame, void(Frame::*func)(const ll::Vector4&, Qt::KeyboardModifiers, ll::Matrix4x4)) {
    auto curQuery = QGuiApplication::queryKeyboardModifiers();
    auto vector4 = ll::Vector4::position(pos.x(), pos.y(), 0);
    (frame->*func)(vector4, curQuery, frame->getViewProjection());
}
