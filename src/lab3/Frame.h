...
public:
    ...
    void setBaseShader(InitFunc newBaseShader);
...
signals:
    void press(const ll::Vector4& pos, Qt::KeyboardModifiers modifiers, ll::Matrix4x4 commonMatrix);
    void pressRight();
    void move(const ll::Vector4& pos, Qt::KeyboardModifiers modifiers, ll::Matrix4x4 commonMatrix);
    void release();
